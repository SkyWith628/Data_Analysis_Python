...
- Chapter 11 — 주성분분석(PCA)로 차원 축소

**미니 실습 (공개 데이터셋 적용)**
- `World_Happiness_Report.ipynb` — 세계 행복도 리포트 데이터로 탐색·시각화
- `LHR_titanic_nomissing.csv` — 타이타닉 데이터 결측치 처리 실습 결과
